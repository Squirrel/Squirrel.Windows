...
_The dream of Squirrel.Windows, risen from the ashes_

This is Squirrel.Windows, rewritten from the [old Squirrel project](https://github.com/Squirrel/OldSquirrelForWindows) to drop a lot of the things that caused the original (never finished) version of Squirrel for Windows. Here's a few examples:
