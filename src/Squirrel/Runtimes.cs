...
namespace Squirrel
{
    ...
    public static partial class Runtimes
    {
        ...
        public static readonly VCRedistInfo VCREDIST140_X86 = new("vcredist140-x86", "Visual C++ 2015 Redistributable (x86)", new(14, 00, 23506), RuntimeCpu.X86);
        /// <summary> Runtime for Visual C++ 2015 Redistributable (x64) </summary>
        public static readonly VCRedistInfo VCREDIST140_X64 = new("vcredist140-x64", "Visual C++ 2015 Redistributable (x64)", new(14, 00, 23506), RuntimeCpu.X64);
        /// <summary> Runtime for Visual C++ 2017 Redistributable (x86) </summary>
        public static readonly VCRedistInfo VCREDIST141_X86 = new("vcredist141-x86", "Visual C++ 2017 Redistributable (x86)", new(14, 15, 26706), RuntimeCpu.X86);
        /// <summary> Runtime for Visual C++ 2017 Redistributable (x64) </summary>
        public static readonly VCRedistInfo VCREDIST141_X64 = new("vcredist141-x64", "Visual C++ 2017 Redistributable (x64)", new(14, 15, 26706), RuntimeCpu.X64);
        /// <summary> Runtime for Visual C++ 2019 Redistributable (x86) </summary>
        public static readonly VCRedistInfo VCREDIST142_X86 = new("vcredist142-x86", "Visual C++ 2019 Redistributable (x86)", new(14, 20, 27508), RuntimeCpu.X86);
        /// <summary> Runtime for Visual C++ 2019 Redistributable (x64) </summary>
        public static readonly VCRedistInfo VCREDIST142_X64 = new("vcredist142-x64", "Visual C++ 2019 Redistributable (x64)", new(14, 20, 27508), RuntimeCpu.X64);
        /// <summary> Runtime for Visual C++ 2022 Redistributable (x86) </summary>
        public static readonly VCRedistInfo VCREDIST143_X86 = new("vcredist143-x86", "Visual C++ 2022 Redistributable (x86)", new(14, 30, 30704), RuntimeCpu.X86);
        /// <summary> Runtime for Visual C++ 2022 Redistributable (x64) </summary>
        public static readonly VCRedistInfo VCREDIST143_X64 = new("vcredist143-x64", "Visual C++ 2022 Redistributable (x64)", new(14, 30, 30704), RuntimeCpu.X64);
